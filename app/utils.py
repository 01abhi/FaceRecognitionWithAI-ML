...
haar = cv2.CascadeClassifier('./notebook/model/haarcascade_frontalface_default.xml')
# pickle files
mean  = pickle.load(open('./notebook/model/mean_preprocess.pickle','rb'))
model_svm  = pickle.load(open('./notebook/model/model_svm.pickle','rb'))
model_pca  = pickle.load(open('./notebook/model/pca_50.pickle','rb'))
